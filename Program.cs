...
namespace LINQedList
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                bool isMultiple = num % 4 == 0 || num % 6 == 0;
                return isMultiple;
            }).ToList();
...
*/
            ...
            {
                bool isMillionaire = num.Balance > 999999;
                return isMillionaire;
            }).GroupBy(customer => customer.Bank);

            foreach (var group in groups)
            {
                Console.WriteLine($"{group.Key} had {group.Count()} customers over $1,000,000 in their account!");
            }
